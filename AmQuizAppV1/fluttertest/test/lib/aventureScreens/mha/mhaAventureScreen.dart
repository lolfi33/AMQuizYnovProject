...
class MHAAventureScreen extends StatefulWidget {
  const MHAAventureScreen({super.key});

  @override
  State<MHAAventureScreen> createState() => _MHAAventureScreenState();
}

class _MHAAventureScreenState extends State<MHAAventureScreen> {
  double tailleEtoiles = 25;
  List<int> recordsMHA = [0, 0, 0, 0, 0, 0, 0, 0];
  ...
  void _initializeData() async {
    List<int>? records = await getRecordsMHA();
