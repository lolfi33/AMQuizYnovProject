...
class SNKGame extends StatefulWidget {
  ...
  @override
  State<SNKGame> createState() => _SNKGameState();
}

class _SNKGameState extends State<SNKGame> {
  // Timer
  ...
  void initializeQuestions() {
    ...
    questionsFuture =
        DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid)
            .getQuestionsAventure("snk", widget.fichierJson);
  }
    ...
    if (indexQuestion == maxQuestion) {
      ...
      if (realScore > widget.record) {
        await DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid)
            .updateRecordsSNK(widget.numeroIle, realScore);
      }
      await DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid)
          .debloqueProchaineIleSNK(widget.numeroIle, realScore);

      showResult(context, maxQuestion + 1, score, widget.fichierJson,
          widget.nomIle, widget.record, widget.numeroIle, "snk");
    } else {
      indexQuestion += 1;
      progress.value = 0;
      tempsActuel = 0;
